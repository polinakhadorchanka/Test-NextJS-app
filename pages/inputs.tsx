      ...
      <div className={'container'}>
        <div className={'content'}>
          ...
          <div className={'content__column content__column_light'}>
            ...
            <Input type={'text'} label={'Disabled input with default value'} required={false} disabled={true}
                   defaultValue={'default value'}/>

            <Input type={'text'} width={'fill'} label={'Login'} required={true}/>
            <Input type={'text'} width={'fill'} label={'Login with default value'} required={true}
                   defaultValue={'default value'}/>
